...
BOARD_PREBUILT_DTBOIMAGE := $(PREBUILT_PATH)/dtbs/aston-23861-23801-dtbo.img
PRODUCT_COPY_FILES += \
...
BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULES_LOAD := $(patsubst %,$(RAMDISK_MODULES_PATH)/%, $(shell cat $(RAMDISK_MODULES_PATH)/modules.load ; cat $(DLKM_MODULES_PATH)/modules.load ))
